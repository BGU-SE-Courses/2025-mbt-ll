...
bthread('Hide', function () {
  ...
  sync({ request: Event("enrollStudent"), waitFor: Event("createCourse"), block: Event("enrollTeacher") });
  enrollStudent(session);

  sync({ request: Event("enrollTeacher"), waitFor: Event("enrollStudent"), block: Event("createForum")});
  enrollTeacher(session);

  // Create a forum
  sync({ request: Event("createForum"), waitFor: Event("createCourse"), block: Event("logoutAdmin"), block: Event("enrollStudent"), block: Event("enrollTeacher")});
  createForum(session)
...
//  sync({ request: Event("enrollStudent"), block: Event("logout"), block: Event("createForum") });
//  enrollStudent(session);
//  sync({ request: Event("studentEnrolled"), block: Event("enrollTeacher") });
//});
//
//bthread('HideEnrollTeacher', function () {
//  let session = new SeleniumSession('hide');
//  sync({ waitFor: Event("gettingToEnrollForHide")});
//  sync({ request: Event("enrollTeacher"), waitFor: Event("studentEnrolled"), block: Event("logout"), block: Event("enrollStudent"), block: Event("createForum")});
//  enrollTeacher(session);
//});
